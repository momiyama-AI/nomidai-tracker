...
require_file "AppStore/github-publish-status.md"
require_file "AppStore/iap-products.md"
require_file "AppStore/signing-diagnostics.md"
require_file "AppStore/testflight-upload-status.md"
require_file "AppStore/ExportOptions.plist"
require_file "scripts/collect-release-evidence.sh"
require_file "scripts/diagnose-signing.sh"
require_file "scripts/upload-testflight.sh"
require_dir "docs"
...
plutil -lint AppStore/ExportOptions.plist >/dev/null && ok "ExportOptions.plist is valid" || fail "ExportOptions.plist is invalid"
...
require_text "NomidaiTracker.xcodeproj/project.pbxproj" "CODE_SIGN_STYLE = Manual;" "Release signing is manual"
require_text "NomidaiTracker.xcodeproj/project.pbxproj" "PROVISIONING_PROFILE_SPECIFIER = \"NomidaiTracker AppStore\";" "App Store app profile is configured"
require_text "NomidaiTracker.xcodeproj/project.pbxproj" "PROVISIONING_PROFILE_SPECIFIER = \"NomidaiTrackerWidget AppStore\";" "App Store widget profile is configured"
...
bash -n scripts/upload-testflight.sh && ok "upload-testflight.sh syntax is valid" || fail "upload-testflight.sh syntax is invalid"
